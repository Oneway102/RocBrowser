...
import com.borqs.browser.BrowserFramework.BookmarkColumns;
import com.borqs.browser.BrowserContract;
import com.borqs.browser.BrowserContract.Accounts;
import com.borqs.browser.BrowserContract.Bookmarks;
import com.borqs.browser.BrowserContract.ChromeSyncColumns;
import com.borqs.browser.BrowserContract.Combined;
import com.borqs.browser.BrowserContract.History;
import com.borqs.browser.BrowserContract.Images;
import com.borqs.browser.BrowserContract.Searches;
import com.borqs.browser.BrowserContract.Settings;
import com.borqs.browser.BrowserContract.SyncState;
import com.borqs.browser.R;
import com.borqs.browser.SyncStateContentProviderHelper;
import com.borqs.browser.UrlUtils;
import com.borqs.browser.widget.BookmarkThumbnailWidgetProvider;
...
public class BrowsingProvider extends SQLiteContentProvider {

	public static final boolean USE_PRODUCT_BOOKMARK = false;
        ...
        switch (match) {
            ...
            case COMBINED: {
                if ((match == LEGACY || match == LEGACY_ID)
                        && projection == null) {
                    projection = BrowserFramework.HISTORY_PROJECTION;
                }
