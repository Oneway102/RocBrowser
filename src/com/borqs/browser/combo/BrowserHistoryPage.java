 ...
 * days of viewing.
 */
public class BrowserHistoryPage extends Activity
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        switch (id) {
            case LOADER_HISTORY: {
                ...
                CursorLoader loader = new CursorLoader(this, combinedBuilder.build(),
    ...
    public void onCreate(Bundle icicle) {
        ...
        mDisableNewWindow = icicle == null ? false : icicle.getBoolean(BrowserBookmarksPage.EXTRA_DISABLE_WINDOW, false);
        int mvlimit = getResources().getInteger(R.integer.most_visits_limit);
        mMostVisitsLimit = Integer.toString(mvlimit);

        
        mRoot = LayoutInflater.from(this).inflate(R.layout.history, null, false);
    ...
    private OnItemClickListener mChildItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(
                AdapterView<?> parent, View view, int position, long id) {
            openUrl(((HistoryItem) view).getUrl());
        }
    };
    ...
    static class ClearHistoryTask extends Thread {
        ...
        @Override
        public void run() {
            // com.borqs.browser.Browser.clearHistory(mResolver);
        }
    }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_to_bookmarks_menu_id:
                if (historyItem.isBookmark()) {
                    ...
                    BrowserFramework.saveBookmark(activity, title, url);
                }
                return true;
            case R.id.share_link_context_menu_id:
            	BrowserFramework.sendString(activity, url,
            ...
            case R.id.delete_context_menu_id:
            	BrowserFramework.deleteFromHistory(activity.getContentResolver(), url);
                return true;
