...
import com.borqs.browser.Reflection;
...
// import com.borqs.browser.BreadCrumbView;
// import com.borqs.browser.BrowserBookmarksAdapter;
...
public class BookmarkExpandableView extends ExpandableListView
    ...
    public void createContextMenu(ContextMenu menu) {
        ...
        Reflection.MenuBuilderSetCurrentMenuInfo(menu, menuInfo);
        ...
        Reflection.MenuBuilderSetCurrentMenuInfo(menu, null);
        if (getParent() != null) {
        ...
        public BreadCrumbView getBreadCrumbView(int groupPosition) {
            ...
            if (crumbs == null) {
                crumbs = (BreadCrumbView)
                        mInflater.inflate(R.layout.combo_bookmarks_header, null);
