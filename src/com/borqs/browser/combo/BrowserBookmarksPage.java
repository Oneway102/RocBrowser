...
import com.borqs.browser.AddBookmarkPage;
import com.borqs.browser.BookmarkUtils;
import com.borqs.browser.Bookmarks;
import com.borqs.browser.BookmarksLoader;
...
import com.borqs.browser.combo.BookmarkExpandableView.BookmarkContextMenuInfo;
import com.borqs.browser.provider.BrowsingProvider;
import com.borqs.browser.BrowserContract;
import com.borqs.browser.BrowserContract.Accounts;
...
//import com.borqs.browser.view.BookmarkExpandableView;
//import com.borqs.browser.view.BookmarkExpandableView.BookmarkContextMenuInfo;
...
public class BrowserBookmarksPage extends Activity implements View.OnCreateContextMenuListener,
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if (id == LOADER_ACCOUNTS) {
            ...
            BookmarksLoader bl = new BookmarksLoader(this,
    ...
    private void populateBookmarkItem(Cursor cursor, BookmarkItem item, boolean isFolder) {
        ...
        if (isFolder) {
            ...
            new LookupBookmarkCount(this, item)
    ...
    private void loadUrl(BrowserBookmarksAdapter adapter, int position) {
        if (adapter != null) {
            onBookmarkSelected(adapter.getItem(position), false);
        }
    }
    ...
    class OpenAllInTabsTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected Cursor doInBackground(Void... params) {
            Context c = BrowserBookmarksPage.this;
    ...
    private void copy(CharSequence text) {
        ClipboardManager cm = (ClipboardManager) this.getSystemService(
...
*/
    ...
    static class AccountsLoader extends CursorLoader {
        ...
        public AccountsLoader(Context context) {
            super(context, Accounts.CONTENT_URI
                    .buildUpon()
                    .appendQueryParameter(BrowsingProvider.PARAM_ALLOW_EMPTY_ACCOUNTS, "false")
                    .build(),
    ...
    public boolean onOpenInNewWindow(String... urls) {
    	...
    	if (activity != null && activity instanceof ComboViewActivityMine) {
    		((ComboViewActivityMine)activity).openInNewTab(urls);
    	}
    	
    	/*
        Intent i = new Intent();
        i.putExtra(ComboViewActivityMine.EXTRA_OPEN_ALL, urls);
    ...
    public boolean onBookmarkSelected(Cursor c, boolean isFolder) {
    	...
    	Activity activity = this.getParent();
    	if (activity != null && activity instanceof ComboViewActivityMine) {
    		((ComboViewActivityMine)activity).openUrl(url);
    	}
