...
*/
        if (Intent.ACTION_VIEW.equals(action)
            ...
            if (intent.getBooleanExtra(android.provider.Browser.EXTRA_CREATE_NEW_TAB, false)
                  || urlData.isPreloaded()) {
            ...
            final String appId = intent
                    .getStringExtra(android.provider.Browser.EXTRA_APPLICATION_ID);
            ...
            if (Intent.ACTION_VIEW.equals(action) ||
                ...
                if (url != null && url.startsWith("http")) {
                    final Bundle pairs = intent
                            .getBundleExtra(android.provider.Browser.EXTRA_HEADERS);
