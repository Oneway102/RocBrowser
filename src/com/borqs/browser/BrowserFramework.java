...
public class BrowserFramework {
     ...
     * identifier.
     */
    public static final String EXTRA_APPLICATION_ID = "com.borqs.browser.application_id";
     ...
     * <p>
     */
    public static final String EXTRA_HEADERS = "com.borqs.browser.headers";
    ...
    public static final void saveBookmark(Context c, 
                                          String title, 
                                          String url) {
        Intent i = new Intent(Intent.ACTION_INSERT, BrowserFramework.BOOKMARKS_URI);
    ...
    public static final void requestAllIcons(ContentResolver cr, String where,
    	...
    	Reflection.WebIconDatabaseBulkRequestIconForPageUrl(WebIconDatabase.getInstance(),cr, where, listener);
    }
