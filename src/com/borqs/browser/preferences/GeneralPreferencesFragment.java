...
public class GeneralPreferencesFragment extends PreferenceFragment
    ...
    String mCurrentPage;
    private AlertDialog mHomepagePromptDialog;
    ...
    void promptForHomepage(final ListPreference pref) {
        ...
        mHomepagePromptDialog = new AlertDialog.Builder(getActivity())
                .setView(editText)
        ...
        editText.setOnEditorActionListener(new OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    mHomepagePromptDialog.getButton(AlertDialog.BUTTON_POSITIVE).performClick();
                    return true;
                }
                return false;
            }
        });
        mHomepagePromptDialog.getWindow().setSoftInputMode(
                WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE);
        mHomepagePromptDialog.show();
    }
    ...
    public void onPause() {
        super.onPause();
        if (mHomepagePromptDialog != null && mHomepagePromptDialog.isShowing()) {
            mHomepagePromptDialog.dismiss();
        }
    }
