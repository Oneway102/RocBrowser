...
public class BreadCrumbView extends LinearLayout implements OnClickListener {
    ...
    private static final int[] DIVIDER_ATTRS = {
    ...
    private void init(Context ctx) {
        ...
        TypedArray a = mContext.obtainStyledAttributes(DIVIDER_ATTRS);
        int separatorDrawableId = a.getResourceId(a.getIndex(DIVIDER), 0);
        mSeparatorDrawable = mContext.getResources().getDrawable(separatorDrawableId);
        a.recycle();
        */
        mSeparatorDrawable = mContext.getResources().getDrawable(R.drawable.divider_vertical_dark);
