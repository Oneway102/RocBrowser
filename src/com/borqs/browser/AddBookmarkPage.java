...
//import android.BrowserContract;
//import android.BrowserContract.Accounts;
...
import com.borqs.browser.addbookmark.FolderSpinner;
import com.borqs.browser.addbookmark.FolderSpinnerAdapter;
...
public class AddBookmarkPage extends Activity
    ...
    /* package */ public static final String EXTRA_EDIT_BOOKMARK = "bookmark";
    /* package */ public static final String EXTRA_IS_FOLDER = "is_folder";
                ...
                if (!url.toLowerCase().startsWith("javascript:")) {
                    ...
                    if (!Bookmarks.urlHasAcceptableScheme(url)) {
                        ...
                        */
                        ...
                        try {
                            // address = new WebAddress(unfilteredUrl);
                        	address = Reflection.newInstaceWebAddress(unfilteredUrl);
                        } catch (ParseException e) {
                            throw new URISyntaxException("", "");
                        }
                        String host = Reflection.WebAddressGetHost(address);
