...
Context mContext;
    ...
    static {
        //Class StrictModeSpan = Class.forName("StrictMode$Span");
    }
...
//        a.recycle();
    ...
    static Class[] paramTypes1 = { String.class };
    static Method StrictMode_enterCriticalSpan;
    static {
        try {
            StrictMode_enterCriticalSpan= StrictMode.class.getMethod(
                    "enterCriticalSpan", paramTypes1);
                ...
                if (mScrollStrictSpan == null) {
                    ...
                    try {
                        m = StrictMode.class.getMethod(
                                "enterCriticalSpan", new Class[]{String.class});
                        mScrollStrictSpan = m.invoke(null, "ScrollView-scroll");
                    } catch (Exception e) {
                        // TODO Auto-generated catch block
                        e.printStackTrace();
                    }
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (!mScroller.isFinished()) {
                    ...
                    if (mFlingStrictSpan != null) {
                        Method m;
                        try {
                            m = mFlingStrictSpan.getClass().getMethod("finish", new Class[]{});
                            m.invoke(null, null);
                        } catch (Exception e) {
                            // TODO Auto-generated catch block
                            e.printStackTrace();
                ...
                if (!mIsBeingDragged) {
                    if (mHorizontal) {
                        ...
                        if (hscroll != 0) {
                            ...
                            Method m; int f = 1;
                            try {
                                m = ScrollerView.this.getClass().getMethod(
                                        "getHorizontalScrollFactor", new Class[]{});
                        ...
                        if (vscroll != 0) {
                            ...
                            try {
                                m = ScrollerView.this.getClass().getMethod(
                                        "getVerticalScrollFactor", new Class[]{});
                                f = (Integer)m.invoke(null, null);
                            } catch (Exception e) {
                                // TODO Auto-generated catch block
                                e.printStackTrace();
    ...
    protected void onOverScrolled(int scrollX, int scrollY,
        ...
        if (!mScroller.isFinished()) {
            ...
            try {
                m = ScrollerView.this.getClass().getMethod(
                        "invalidateParentIfNeeded", new Class[]{});
                m.invoke(null, null);
            } catch (Exception e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            //         thinks it is.
            //
            int oldX = (int)getScaleX();
            int oldY =(int)getScaleY();
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mScrollStrictSpan != null) {
            Method m;
            try {
                m = mScrollStrictSpan.getClass().getMethod("finish", new Class[]{});
                m.invoke(null, null);
            } catch (Exception e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
    ...
    public void fling(int velocityY) {
        if (getChildCount() > 0) {
            ...
            if (mFlingStrictSpan == null) {
                ...
                try {
                    mFlingStrictSpan = StrictMode_enterCriticalSpan.invoke("ScrollView-fling");
                } catch (Exception e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
