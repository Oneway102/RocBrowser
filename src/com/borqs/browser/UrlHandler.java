...
public class UrlHandler {
   ...
   boolean shouldOverrideUrlLoading(Tab tab, ContentView view, String url) {
       /* ww
       if (((BrowserContentView)view).isPrivateBrowsingEnabled()) {
   ...
   boolean startActivityForUrl(Tab tab, String url) {
     ...
     if (tab != null) {
         ...
         intent.putExtra(android.provider.Browser.EXTRA_APPLICATION_ID, tab.getAppId());
     }
   ...
   private class RLZTask extends AsyncTask<Void, Void, String> {
       ...
       private ContentView mWebView;

       public RLZTask(Tab tab, Uri uri, ContentView webView) {
           mTab = tab;
           mSiteUri = uri;
           mWebView = webView;
       }
